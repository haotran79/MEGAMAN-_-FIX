...
import static com.hao.gameObjects.ParticularObject.ALIVE;
import static com.hao.gameObjects.ParticularObject.BEHURT;
import java.awt.Graphics2D;
import java.awt.Rectangle;

public class BlueFire11 extends Bullet{
    
    private Animation forwardBulletAnim, backBulletAnim;
    
    private float y1;
    
    public BlueFire11(float x, float y, GameWorld gameWorld){
